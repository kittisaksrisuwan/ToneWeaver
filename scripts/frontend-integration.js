 ...
 * This file demonstrates how to integrate Toneweaver with a web frontend
 */

// For React/Vue/Angular applications
export class ToneweaverClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ToneweaverClient(provider, contractAddress);
